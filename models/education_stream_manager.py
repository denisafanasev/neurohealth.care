...
class EducationStreamManager():
    ...
    def create_education_stream(self, _education_stream):
        ...
        education_stream = EducationStream(_name=_education_stream['name'], _id_course=_education_stream['id_course'],
                                           _teacher=_education_stream['teacher'],
                                           _date_start=_education_stream['date_start'],
                                           _date_end=_education_stream['date_end'],
                                           _curators_list=_education_stream['curators_list'],
                                           _students_list=_education_stream['students_list'])

        id_education_stream = data_store.insert_row({'name': education_stream.name,
                                                     ...
                                                     "id_course": education_stream.course,
                                                     "curators_list": education_stream.curators_list,
                                                     "students_list": education_stream.students_list})

        education_stream = data_store.get_row_by_id(id_education_stream)
